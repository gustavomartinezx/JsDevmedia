...
var tamanho_do_objeto = curiosidades_chuck_norris.length;

var numero_sorteado = Math.floor(Math.random() * tamanho_do_objeto);

var curiosidade_escolhida = curiosidades_chuck_norris[numero_sorteado]
var titulo_da_curiosidade = curiosidade_escolhida.titulo;
var conteudo_da_curiosidade = curiosidade_escolhida.conteudo;

console.log("Titulo : " + titulo_da_curiosidade);
console.log("Conteudo : " + conteudo_da_curiosidade);